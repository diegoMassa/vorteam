...
*/
@Scope("singleton")
@Service("SegSucursalLogic")
public class SegSucursalLogic implements ISegSucursalLogic {
    private static final Logger log = LoggerFactory.getLogger(SegSucursalLogic.class);
    ...
    */
    ...
    public List<SegSucursal> getSegSucursal() throws Exception {
        log.debug("finding all SegSucursal instances");

        List<SegSucursal> list = new ArrayList<SegSucursal>();

        try {
            list = segSucursalDAO.findAll();
        } catch (Exception e) {
            log.error("finding all SegSucursal failed", e);
    ...
    public void saveSegSucursal(SegSucursal entity) throws Exception {
        log.debug("saving SegSucursal instance");
        ...
        try {
            ...
            if (entity.getSucCodigo() == null) {
                throw new ZMessManager().new EmptyFieldException("sucCodigo");
            }

            if (entity.getSucCodigoInterno() == null) {
            ...
            if ((entity.getSucCodigoInterno() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getSucCodigoInterno(), 15) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "sucCodigoInterno");
            }

            if (entity.getSucEstadoRegistro() == null) {
                throw new ZMessManager().new EmptyFieldException(
                    "sucEstadoRegistro");
            }
            ...
            if ((entity.getSucEstadoRegistro() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getSucEstadoRegistro(), 1) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "sucEstadoRegistro");
            }

            if (entity.getSucNombre() == null) {
                throw new ZMessManager().new EmptyFieldException("sucNombre");
            }

            if ((entity.getSucNombre() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getSucNombre(), 100) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "sucNombre");
            }
            ...
            if (getSegSucursal(entity.getSucCodigo()) != null) {
                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
            }

            segSucursalDAO.save(entity);

            log.debug("save SegSucursal successful");
        } catch (Exception e) {
            log.error("save SegSucursal failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public void deleteSegSucursal(SegSucursal entity) throws Exception {
        log.debug("deleting SegSucursal instance");

        if (entity == null) {
            throw new ZMessManager().new NullEntityExcepcion("SegSucursal");
        }
        ...
        try {
            segPermisos = segPermisoDAO.findByProperty("segSucursal.sucCodigo",
                    entity.getSucCodigo());
            ...
            log.debug("delete SegSucursal successful");
        } catch (Exception e) {
            log.error("delete SegSucursal failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public void updateSegSucursal(SegSucursal entity) throws Exception {
        log.debug("updating SegSucursal instance");
        ...
        try {
            ...
            segSucursalDAO.update(entity);

            log.debug("update SegSucursal successful");
        } catch (Exception e) {
            log.error("update SegSucursal failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public List<SegSucursalDTO> getDataSegSucursal() throws Exception {
        try {
            List<SegSucursal> segSucursal = segSucursalDAO.findAll();
            ...
            for (SegSucursal segSucursalTmp : segSucursal) {
                ...
                segSucursalDTO2.setSucCodigo(segSucursalTmp.getSucCodigo());
                segSucursalDTO2.setSucCodigoInterno((segSucursalTmp.getSucCodigoInterno() != null)
                    ? segSucursalTmp.getSucCodigoInterno() : null);
                segSucursalDTO2.setSucEstadoRegistro((segSucursalTmp.getSucEstadoRegistro() != null)
                    ? segSucursalTmp.getSucEstadoRegistro() : null);
                segSucursalDTO2.setSucNombre((segSucursalTmp.getSucNombre() != null)
                    ? segSucursalTmp.getSucNombre() : null);
                segSucursalDTO2.setCiaCodigo_SegCompania((segSucursalTmp.getSegCompania()
                                                                        .getCiaCodigo() != null)
                    ? segSucursalTmp.getSegCompania().getCiaCodigo() : null);
                segSucursalDTO2.setUsuCodigo_SegUsuario((segSucursalTmp.getSegUsuario()
                                                                       .getUsuCodigo() != null)
                    ? segSucursalTmp.getSegUsuario().getUsuCodigo() : null);
    ...
    public SegSucursal getSegSucursal(Long sucCodigo) throws Exception {
        log.debug("getting SegSucursal instance");

        SegSucursal entity = null;

        try {
            entity = segSucursalDAO.findById(sucCodigo);
        } catch (Exception e) {
            log.error("get SegSucursal failed", e);
    ...
    public List<SegSucursal> findPageSegSucursal(String sortColumnName,
        ...
        try {
            entity = segSucursalDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<SegSucursal> findByCriteria(Object[] variables,
        ...
        try {
            list = segSucursalDAO.findByCriteria(where);
        } catch (Exception e) {
