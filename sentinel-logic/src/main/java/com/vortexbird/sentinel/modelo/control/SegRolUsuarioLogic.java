    ...
    */
    ...
    public void saveSegRolUsuario(SegRolUsuario entity)
        ...
        try {
            ...
            if (entity.getSegUsuarioBySegUsuarioUsuCodigo() == null) {
                throw new ZMessManager().new ForeignException(
                    "segUsuarioBySegUsuarioUsuCodigo");
            }

//            if (entity.getRluCodigo() == null) {
//                throw new ZMessManager().new EmptyFieldException("rluCodigo");
//            }

            if (entity.getRluEstadoRegistro() == null) {
            ...
            if ((entity.getRluEstadoRegistro() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getRluEstadoRegistro(), 1) == false)) {
...
//            }
            ...
            if (entity.getSegUsuarioBySegUsuarioUsuCodigo().getUsuCodigo() == null) {
                throw new ZMessManager().new EmptyFieldException(
                    "usuCodigo_SegUsuario");
            }

//            if (getSegRolUsuario(entity.getRluCodigo()) != null) {
...
//            }
    ...
    public List<SegRolUsuarioDTO> getDataSegRolUsuario()
        ...
        try {
            ...
            for (SegRolUsuario segRolUsuarioTmp : segRolUsuario) {
                ...
                segRolUsuarioDTO2.setRluCodigo(segRolUsuarioTmp.getRluCodigo());
                segRolUsuarioDTO2.setRluEstadoRegistro((segRolUsuarioTmp.getRluEstadoRegistro() != null)
                    ? segRolUsuarioTmp.getRluEstadoRegistro() : null);
                segRolUsuarioDTO2.setRolCodigo_SegRol((segRolUsuarioTmp.getSegRol()
                                                                       .getRolCodigo() != null)
                    ? segRolUsuarioTmp.getSegRol().getRolCodigo() : null);
                
                segRolUsuarioDTO2.setUsuCodigo_SegUsuarioCrea((segRolUsuarioTmp.getSegUsuarioBySegUsuarioUsuCodigo()
                                                                           .getUsuCodigo() != null)
                    ? segRolUsuarioTmp.getSegUsuarioBySegUsuarioUsuCodigo().getUsuCodigo() : null);
    ...
    public SegRolUsuario getSegRolUsuario(Long rluCodigo)
        ...
        try {
            entity = segRolUsuarioDAO.findById(rluCodigo);
        } catch (Exception e) {
