...
public class Utilities {
	...
	public static boolean esCorreElectronico(String entrada){
	...
	public static String crearContraseña(String primerNombre, String primerApellido, String numeroDocumento) {
		String respuesta="";
		if (!primerApellido.equals("")) {
			respuesta=respuesta+(primerNombre.charAt(0));
		}
		if (!primerApellido.equals("")) {
			respuesta=respuesta+primerApellido.charAt(0);
		}
		if (!numeroDocumento.equals("")) {
			respuesta=respuesta+numeroDocumento.substring(0, 4);
		}
